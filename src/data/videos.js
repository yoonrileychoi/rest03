...
export const videos = {
  ...
  'web': [
    ...
    { id: 'phiSW6Pr-gg', title: 'HTML·CSS·JavaScript 웹 개발 핵심 7시간 완성', desc: '웹 개발의 핵심 3종 세트를 단 7시간 만에 끝내는 완성형 강의' },
    { id: 'sTJz4IufhSM', title: '한 시간만에 홈페이지 개발하기 입문', desc: '초보자도 1시간이면 가능! HTML·CSS 기초부터 실제 홈페이지 제작까지' },
    { id: 'HdHvEWMcQGc', title: '코딩 몰라도 9분안에 웹사이트 3가지 만들기', desc: '코딩 아예 몰라도 괜찮아요 — AI 도구로 9분 만에 웹사이트 뚝딱' },
    { id: 'cKLdYMTiC2I', title: 'AI가 코딩·디자인 자동으로 합니다', desc: '웹사이트 개발자들 멘붕! Readdy AI로 기획·디자인·개발을 한번에' },
    { id: 'GUTN2GEYUb0', title: '워드프레스 웹사이트 만들기 2026', desc: '20단계 쉬운 튜토리얼 | 초보자를 위한 워드프레스 강의 최신판' },
  ],
}
